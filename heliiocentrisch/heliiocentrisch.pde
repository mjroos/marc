...
void setup() {
 ...
 sun1=new Planet(color(242,158,46),0/bs,0/bs);
 sun2=new Planet(color(242,158,46),0/bs, 0/bs);
  ...
  aarde1=new Planet(color(42,11,222),150/bs, 150/bs);
  aarde2=new Planet(color(42,11,222),150/bs, 150/bs);
...
void draw() {
  background(255);
  text("Heliocentrich Heelal",10,750);
  text("Nicolaas Copernicus, 1473 - 1543",10,780 );
  ...
  aarde1.cirkel(0,0,150/bs, 150/bs);
  aarde2.coor(6/ps,0.0149);
  aarde2.tekst("Aarde");
  ...
  sun1.cirkel(0,0,0/bs, 0/bs);
  sun2.coor(12/ps,0.00006);
  sun2.tekst("sun");
